...
#define ECALL(dnpc) { bool success; printf("a7:%d\n",isa_reg_str2val("a7", &success));dnpc = (isa_raise_intr(isa_reg_str2val("a7", &success), s->pc)); }
...
int isa_exec_once(Decode *s) {
  ...
  IFDEF(CONFIG_ITRACE, iringbuf_write_inst(s->pc, s->isa.inst.val));
