...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 100 ????? 01100 11", sltu  , R, R(rd) = src1 ^ src2);
  INSTPAT("0000000 ????? ????? 110 ????? 01100 11", sltu  , R, R(rd) = src1 | src2);
  INSTPAT("0000000 ????? ????? 001 ????? 01000 11", sh  , S, Mw(src1 + imm, 2, src2));
